...
CREATE TABLE `tblCons` (
	...
	`UseRCG` tinyint(1) NOT NULL DEFAULT '0',
	`UseRestrictedAdmin` tinyint(1) NOT NULL DEFAULT '0',
	`InheritUseRCG` tinyint(1) NOT NULL DEFAULT '0',
	`InheritUseRestrictedAdmin` tinyint(1) NOT NULL DEFAULT '0',
